 ...
 */
final class Version20240515091151 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE referent (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, association_id INT DEFAULT NULL, tel VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_FE9AAC6CA76ED395 (user_id), INDEX IDX_FE9AAC6CEFB9C8A5 (association_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
