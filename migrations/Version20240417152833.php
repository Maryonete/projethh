 ...
 */
final class Version20240417152833 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE association (id INT AUTO_INCREMENT NOT NULL, president_id INT NOT NULL, code INT NOT NULL, libelle VARCHAR(255) NOT NULL, adress LONGTEXT NOT NULL, cp VARCHAR(255) NOT NULL, city VARCHAR(255) NOT NULL, tel VARCHAR(255) DEFAULT NULL, email VARCHAR(255) NOT NULL, INDEX IDX_FD8521CCB40A33C7 (president_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE association_referent (association_id INT NOT NULL, referent_id INT NOT NULL, INDEX IDX_C857B40AEFB9C8A5 (association_id), INDEX IDX_C857B40A35E47E35 (referent_id), PRIMARY KEY(association_id, referent_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE association_referent ADD CONSTRAINT FK_C857B40AEFB9C8A5 FOREIGN KEY (association_id) REFERENCES association (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE association_referent ADD CONSTRAINT FK_C857B40A35E47E35 FOREIGN KEY (referent_id) REFERENCES referent (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE association_referent DROP FOREIGN KEY FK_C857B40AEFB9C8A5');
        $this->addSql('ALTER TABLE association_referent DROP FOREIGN KEY FK_C857B40A35E47E35');
        ...
        $this->addSql('DROP TABLE association_referent');
