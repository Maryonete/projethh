 ...
 */
final class Version20240419141951 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE association (id INT AUTO_INCREMENT NOT NULL, president_id INT NOT NULL, referent_id INT NOT NULL, code INT NOT NULL, libelle VARCHAR(255) NOT NULL, adress LONGTEXT NOT NULL, cp VARCHAR(255) NOT NULL, city VARCHAR(255) NOT NULL, tel VARCHAR(255) DEFAULT NULL, email VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_FD8521CCB40A33C7 (president_id), UNIQUE INDEX UNIQ_FD8521CC35E47E35 (referent_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE president (id INT AUTO_INCREMENT NOT NULL, association_id INT DEFAULT NULL, user_id INT NOT NULL, fonction VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_6E8BD214EFB9C8A5 (association_id), UNIQUE INDEX UNIQ_6E8BD214A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE referent (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, association_id INT DEFAULT NULL, tel VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_FE9AAC6CA76ED395 (user_id), UNIQUE INDEX UNIQ_FE9AAC6CEFB9C8A5 (association_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
